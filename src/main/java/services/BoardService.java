...
public class BoardService {
    ...
    private void initializePieces() {
        ...
        KingStrategy wk = new KingStrategy(new King(1, squares[0][4], RESOURCES_BKING_PNG.label));
        ...
        squareBoard[7][1].put(new KnightStrategy(new Knight(0, squares[7][1], RESOURCES_BKNIGHT_PNG.label)));
        ...
        squareBoard[7][2].put(new BishopStrategy(new Bishop(0, squares[7][2], RESOURCES_BBISHOP_PNG.label)));
    ...
    public void capture(Piece p, SquareService squareService) {
        ...
        squareService.setOccupyingPiece(piece);
    }
